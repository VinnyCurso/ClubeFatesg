...
public class testeAssociado {
    ...
    public static void main(String[] args) {
        ...
        associado.setNome("Beltrano");
        associado.setEndereco("Rua dos testes");
        associado.getTipoAssociado().setCodigo(1);

        PAssociado persistencia = new PAssociado();
        try {
            persistencia.incluir(associado);
...
//        } catch (SQLException ex) {
//            Logger.getLogger(testeAssociado.class.getName()).log(Level.SEVERE, null, ex);
//        }
//        
